...
from .components import (
    ...
    AppTheme, AppConfig, UploadButton, LoadingIndicator
)
...
class PreprocessingPanel:
    ...
    def _create_na_stats_section(self, master):
        ...
        if nas_total > 0:
            ...
            info_text = "✓ No hay valores "
            "faltantes en las columnas seleccionadas"
    ...
    def _apply_preprocessing_thread(self):
        """Aplicar el preprocesamiento
           según la opción seleccionada (en hilo)."""
    ...
    def _fill_with_mean(self):
        ...
        if not numeric_cols:
            NotificationWindow(
                ...
                "en la selección para calcular la media.",
                "warning"
            )
            return
